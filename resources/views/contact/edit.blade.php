                                        ...
                                        <form action="{{ route('contact.update',$contacts->id) }}" method="POST">
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <input name="first_name" type="text" class="form-control"
                                                    placeholder="Enter First Name..." value="{{ $contacts->first_name }}" />
                                                @error('first_name')
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <input name="last_name" type="text" class="form-control"
                                                    placeholder="Enter Last Name..." value="{{ $contacts->last_name }}" />
                                                @error('last_name')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <input name="email" type="email" class="form-control"
                                                    placeholder="Enter your email.." value="{{ $contacts->email }}" />
                                                @error('email')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <input name="mobile" type="number" class="form-control"
                                                    placeholder="Enter mobile no " value="{{ $contacts->mobile }}" />
                                                @error('mobile')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
